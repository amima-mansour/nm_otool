...
nm_bin_ex="/Users/amansour/Desktop/42Projects/test/ft_nm_example"
nm_bin="/Users/amansour/Desktop/42Projects/test/ft_nm"
...
do
    ...
    for file in $loop; do
        ...
        # CHECK OUTPUT WITH EXAMPLE
        ex_nm="$("$nm_bin_ex" $file 2>&1)"
        #if [[ "$ex_nm" == "$my_nm" ]]; then
        #     printf "      $GREEN%s$DEF" "OK"
        #else
        #    printf "       $RED%s$DEF" "KO"
        #fi
